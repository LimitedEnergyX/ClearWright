...
HEAD (bytes under review):   82312d447cbb00beb5840066ab010346f6b744f6
...
----------------------------------------------------------------------
  ...
  full suite       1409 tests  (OK, skipped=1)
...
full.
  ...
  added/changed test classes (50):
    SelectionRestorationTest
    FallbackRankingTest
    EmptyStateTest
    ConversationFirstTest
    ComposerBindingTest
    RouteParsingTest
    RouteErrorPersistenceTest
    UnifiedActivationTest
    StrictRouteProofTest
    QueueReconciliationTest
    WiredPathCoverageTest
    LiveRecordRequiredTest
    CanonicalDestinationTest
    SelectorEscapingTest
    QueueFreshnessTest
    ReadOnlyProjectionTest
    RefreshOutcomeTest
    RefreshFailureVisibilityTest
    RefreshSequencingTest
    CssStringEscapingTest
    RefreshPayloadValidationTest
    RecordPolicyDocumentationTest
    CanonicalIdentityTest
    QueueTileIdentityTest
    IdentifierTerminologyTest
    HistoryColumnsTest
    DestinationAgreementTest
    LoadedEmptyQueueTest
    PhaseVersusExecutorTest
    ComposerSubmissionFeedbackTest
    UnifiedRoutePolicyTest
    RouteErrorLatchTest
    EmptyRouteTest
    StaleRouteClearingTest
    DeepLinkPolicyTest
    RuntimeCoverageTest
    UnresolvedDestinationTest
    StaleDeepLinkTest
    JumpToLatestWiringTest
    ObservableFailureTest
    ContextualRailCompletenessTest
    DeliberateNewConversationTest
    ConversationSurfaceTest
    TargetedComposerTest
    MessageIdentityTest
    TruthfulExecutionStateTest
    ConsistentDemotionTest
    IdentifierFidelityTest
    AccessibilityTest
    SemanticsPreservedTest

  added/changed tests (202):
    test_selection_is_persisted_under_a_single_stable_key
    test_select_task_persists_the_choice
    test_persistence_failure_is_survivable
    test_restore_runs_at_boot_after_the_queue_loads
    test_explicit_deep_link_wins_over_stored_selection
    test_stale_stored_selection_is_not_used
    test_priority_order_matches_the_operator_specification
    test_operator_message_posted_is_removed_as_unreachable
    test_wake_pending_is_deferred_not_simulated
    test_every_ranked_state_is_reachable_from_the_mapping
    test_ranking_filters_to_active_items_only
    test_completed_items_are_never_auto_selected
    test_ranking_is_stable_by_recent_activity
    test_ranking_delegates_to_the_single_truthful_mapping
    test_unknown_states_are_not_guessed
    test_ranking_has_a_deterministic_final_key
    test_no_active_work_clears_the_selection_and_returns
    test_duplicate_no_task_selected_placeholders_are_gone
    test_rail_is_hidden_rather_than_showing_empty_cards
    test_navigation_opens_the_conversation_tab
    test_navigation_lands_on_the_latest_message
    test_scroll_is_preserved_only_when_deliberately_moved_away
    test_jump_to_latest_control_exists_and_is_a_button
    test_composer_target_binds_to_the_selected_work_item
    test_work_item_id_is_only_sent_with_a_durable_thread
    test_selection_change_refreshes_the_destination
    test_navigation_binds_the_real_durable_thread
    test_deep_link_binds_the_thread_the_same_way
    test_confirmed_target_contract_is_not_weakened
    test_one_guarded_parser_is_shared
    test_no_unguarded_decode_remains_on_the_route_paths
    test_boot_route_reports_a_malformed_link
    test_a_bad_message_fragment_does_not_discard_a_valid_work_id
    test_a_reported_route_error_is_not_transient
    test_boot_uses_the_transient_clear
    test_malformed_boot_route_clears_the_selection
    test_the_boot_message_does_not_contradict_restoration
    test_mouse_activation_goes_through_navigation
    test_there_is_one_navigation_operation
    test_keyboard_uses_native_button_semantics
    test_an_absent_route_refuses
    test_a_malformed_route_refuses
    test_the_check_no_longer_requires_a_non_malformed_route_to_apply
    test_a_no_change_poll_does_not_touch_the_dom
    test_reconciliation_is_keyed_by_canonical_work_item_id
    test_an_unchanged_tile_is_reused_not_replaced
    test_wholesale_replacement_is_gone_from_the_render_path
    test_focus_is_captured_and_restored_around_reconciliation
    test_lost_focus_moves_predictably_not_to_the_body
    test_no_stale_item_is_retained_to_preserve_focus
    test_the_signature_covers_every_rendered_field
    test_a_wired_path_harness_exists
    test_it_installs_the_real_wire
    test_it_dispatches_real_clicks_and_keys
    test_it_proves_focus_survives_polling
    test_it_drives_the_real_send_through_refusals
    test_the_mini_dom_states_its_limitation
    test_a_live_record_helper_exists
    test_the_target_thread_comes_only_from_the_live_record
    test_the_destination_check_requires_a_live_record
    test_the_thread_comparison_is_no_longer_optional
    test_a_canonical_shape_test_exists
    test_packet_projections_are_excluded_by_shape
    test_the_destination_check_rejects_non_canonical_ids
    test_reconciliation_skips_records_without_a_canonical_id
    test_a_single_escaper_exists
    test_identifier_escaping_is_not_used_in_code
    test_every_dynamic_selector_is_escaped
    test_the_escaper_targets_string_literal_semantics
    test_a_confirmation_flag_exists_and_is_separate_from_loaded
    test_a_successful_refresh_confirms_the_queue
    test_a_failed_refresh_withdraws_confirmation
    test_the_send_gate_requires_a_confirmed_queue
    test_the_freshness_check_precedes_the_record_lookup
    test_the_previous_content_is_not_blanked
    test_canonicality_is_decided_in_the_card
    test_only_canonical_records_get_an_activation_control
    test_non_canonical_records_remain_visible
    test_the_projection_is_labelled
    test_stale_role_button_css_is_removed
    test_the_four_outcomes_are_named_constants
    test_confirmed_empty_is_distinct_from_failed_and_unloaded
    test_a_success_helper_gates_the_callers
    test_the_boot_path_acts_only_on_a_confirmed_success
    test_the_retry_control_branches_the_same_way
    test_refresh_does_not_signal_failure_by_throwing
    test_a_reported_failure_is_tracked_separately
    test_transient_cleanup_cannot_erase_it
    test_only_a_confirmed_success_clears_it
    test_the_failure_keeps_the_snapshot_visible
    test_a_monotonic_generation_exists
    test_both_completion_paths_are_guarded
    test_a_superseded_completion_touches_no_shared_state
    test_the_guard_precedes_the_snapshot_write
    test_control_characters_are_escaped
    test_the_comment_no_longer_overclaims
    test_the_payload_shape_is_validated
    test_a_malformed_payload_is_a_failure
    test_the_previous_snapshot_survives_a_malformed_payload
    test_the_two_cases_are_documented_where_enforced
    test_queue_identity_is_derived_from_the_canonical_work_item_id
    test_a_thread_id_is_never_rendered_as_a_work_item
    test_shared_thread_raises_an_integrity_warning
    test_conflicting_records_are_flagged_not_hidden
    test_tile_shows_work_item_thread_and_origin_ids
    test_tile_offers_copy_for_each_identifier
    test_copy_controls_carry_the_full_id_not_the_abbreviation
    test_copying_does_not_also_open_the_item
    test_matching_suffix_is_explained_rather_than_hidden
    test_the_explanation_says_they_remain_different_identifiers
    test_identifiers_are_not_case_transformed_on_tiles
    test_history_has_distinct_identifier_columns
    test_the_substitution_fallback_is_gone
    test_a_missing_binding_is_stated_honestly
    test_message_id_column_is_only_populated_for_messages
    test_colspan_matches_the_new_column_count
    test_a_disagreement_check_exists
    test_it_compares_route_selection_and_thread
    test_no_body_is_built_when_they_disagree
    test_the_operator_is_told_why
    test_a_loaded_flag_exists_and_is_set_on_success
    test_validation_no_longer_infers_from_length
    test_phase_and_executor_are_separate_functions
    test_phase_comes_from_status_only
    test_executor_comes_from_runner_state_only
    test_labels_cover_exactly_the_server_domain
    test_active_requires_positive_runner_evidence
    test_the_tile_labels_both_separately
    test_the_button_reports_the_in_flight_state
    test_the_button_is_disabled_while_in_flight
    test_the_label_is_captured_not_hardcoded_on_restore
    test_state_is_restored_in_finally_so_it_cannot_strand
    test_duplicate_submission_is_blocked_for_every_entry_point
    test_the_draft_is_kept_until_durable_success
    test_failure_paths_preserve_the_draft
    test_success_shows_the_durable_id_and_destination
    test_one_shared_policy_function_exists
    test_the_hashchange_path_validates
    test_restoration_uses_the_same_policy_not_a_copy
    test_the_policy_persists_nothing_terminal
    test_an_unknown_route_is_cleared_on_every_path
    test_a_successful_route_resets_the_latch
    test_explicit_navigation_resets_the_latch
    test_empty_work_id_is_invalid_not_absent
    test_invalid_route_is_removed_from_the_url
    test_selection_is_cleared_unconditionally
    test_terminal_deep_link_is_not_persisted_as_active
    test_the_policy_is_documented_where_it_is_enforced
    test_automatic_restoration_still_excludes_terminal_items
    test_a_runtime_harness_exists_and_is_dependency_free
    test_the_harness_states_its_limitation
    test_the_harness_covers_the_defects_that_actually_occurred
    test_target_reports_unresolved_instead_of_a_bare_work_item
    test_send_is_refused_while_the_destination_is_unresolved
    test_refusal_happens_before_the_body_is_built
    test_banner_does_not_present_an_unresolved_target_as_valid
    test_unknown_deep_link_clears_the_selection
    test_unknown_deep_link_is_reported_not_silent
    test_button_is_actually_activated
    test_visibility_is_driven_by_deliberate_scroll
    test_new_content_does_not_yank_a_deliberate_position
    test_it_is_wired_at_boot
    test_scroll_target_is_the_element_that_actually_scrolls
    test_content_anchor_and_scroller_are_distinct
    test_scroll_is_observed_by_capture_on_window
    test_restoration_failure_is_reported
    test_failure_offers_a_retry
    test_status_is_announced
    test_operator_actions_card_is_inside_the_rail
    test_only_one_actions_card_exists
    test_an_explicit_control_clears_the_selection
    test_the_affordance_is_documented_where_demotion_happens
    test_demotion_is_exactly_reversible
    test_open_conversation_does_not_depend_on_a_nonexistent_tab
    test_open_conversation_reveals_the_work_view
    test_no_conversation_tab_control_is_invented_in_markup
    test_destination_shows_work_item_thread_and_title
    test_destination_comes_from_the_selection_not_the_message_text
    test_generic_composer_is_demoted_while_work_is_selected
    test_demotion_is_reapplied_on_every_selection_change
    test_generic_composer_is_not_removed_only_demoted
    test_identity_row_is_rendered_on_every_message_card
    test_copy_controls_are_real_keyboard_reachable_buttons
    test_copy_uses_the_clipboard_api_and_degrades_safely
    test_post_send_confirmation_exposes_the_new_message_id
    test_confirmation_fires_only_after_the_durable_verify
    test_confirmation_region_is_a_polite_live_region
    test_no_duplicate_github_issue_is_referenced
    test_operator_message_does_not_yield_a_running_state
    test_unsupported_states_are_not_simulated
    test_the_obsolete_vocabulary_is_removed_not_left_dead
    test_state_is_actually_RENDERED_on_the_queue_row
    test_demotion_removes_a11y_and_tab_order_together
    test_fallback_covers_every_focusable_not_just_the_textarea
    test_identifiers_are_not_case_transformed
    test_queue_rows_are_real_controls
    test_queue_rows_activate_via_a_native_button
    test_existing_send_shortcuts_are_preserved
    test_focus_rings_exist_for_new_controls
    test_no_server_side_change_is_required_by_this_slice
    test_identity_helpers_only_read_existing_fields
    test_restoration_never_mutates_durable_state
